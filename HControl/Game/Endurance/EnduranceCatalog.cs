...
namespace HControl.Game.Endurance {
    public class EnduranceCatalog : RoundCatalog {
        ...
        public static GameRound[] GentleRounds {
            get {
                return [
        ...
        public static GameRound[] NormalRounds {
            get {
                return [
        ...
        public static GameRound[] EvilRounds {
            get {
                return [
        ...
        public static GameRound[] LongRounds {
            get {
                return [
